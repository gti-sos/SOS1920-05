	...
	async function loadGraph(){
        ...
        let datosConjuntos = [{name: "Esperanza de vida media",data: MyDataGraph},{name: "Coches por cada 1000 habitantes",data: OtherDataGraph}];
...
<main>
    <h3> Grafica esperanza de vida media y coches por cada 1000 habitantes</h3>
