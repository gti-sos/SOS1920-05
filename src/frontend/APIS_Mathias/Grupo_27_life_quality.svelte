	...
	async function loadGraph(){
        ...
        let OtherDataGraph = OtherData.map((x) => {
			let res = {name: x.country + " " + x.year, value: x["total"]};
			return res;
        });
        
        let datosConjuntos = [{name: "Esperanza de vida media",data: MyDataGraph},{name: "puntuación total de calidad de vida ",data: OtherDataGraph}];
...
<main>
    <h3> Grafica esperanza de vida media y puntuación total de calidad de vida</h3>
