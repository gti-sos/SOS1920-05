<script>
	...
	async function loadGraph(){
        ...
        let OtherDataGraph = OtherData.map((x) => {
			let res = {name: x.province + " " + x.year, value: x["mortalAccident"]};
			return res;
        });
        
        let datosConjuntos = [{name: "Gasto público", data: MyDataGraph}, {name: "Accidentes mortales",data: OtherDataGraph}];
        ...
        Highcharts.chart('container', {
            ...
            title: {
                text: 'Gráfica que representa el gasto público y los accidentes mortales'
            },
			tooltip: {
				useHTML: true,
