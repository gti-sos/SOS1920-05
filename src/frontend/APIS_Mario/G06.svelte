<script>
	...
	async function loadGraph(){
        ...
        let datosConjuntos = [{name: "Gasto público", data: MyDataGraph}, {name: "Hospitalizaciones urbanas",data: OtherDataGraph}];
        ...
        Highcharts.chart('container', {
            ...
            title: {
                text: 'Gráfica que representa el gasto público y las hospitalizaciones urbanas'
            },
			tooltip: {
				useHTML: true,
